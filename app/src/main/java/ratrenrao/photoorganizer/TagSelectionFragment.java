 ...
 */
public class TagSelectionFragment extends Spinner implements OnMultiChoiceClickListener {
    String[] _items = null;
     ...
     * @param context
     */
    public TagSelectionFragment(Context context) {
        super(context);
     ...
     * @param attrs
     */
    public TagSelectionFragment(Context context, AttributeSet attrs) {
        super(context, attrs);
